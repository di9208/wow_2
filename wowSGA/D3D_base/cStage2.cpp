...
void cStage2::SetQuad()
{
	m_QuadTree->Add(MapVertex);
}

void cStage2::SetMaterial()
{
	D3DMATERIAL9 mt;
...
void cStage2::SkyRender(D3DXVECTOR3 camera)
{
	m_skybox->Render(camera);
}

bool cStage2::GetHeight(IN float x, OUT float & y, IN float z)
{
